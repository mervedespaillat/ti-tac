...
describe "Board" do
    ...
    describe "::build_stacks" do
        ...
        it "should return a 2D array containing the given number of 
        empty stacks (subarrays of length 0)" do
    ...
    describe "#initialize" do
        ...
        it "should set @stacks to a 2D array containing the specified number
         of empty stacks" do
